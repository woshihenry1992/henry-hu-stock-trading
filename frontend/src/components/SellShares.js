      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {selectedLots.length > 0 && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-md border border-blue-200">
            ...
            {sellPrice && totalSelectedShares > 0 && (
              <div className="mb-3">
                <div className="text-sm text-blue-700 mb-1">Selling Cost:</div>
                <div className="text-lg font-semibold text-blue-900">
                  ${sellingCost.toFixed(2)}
                </div>
                <div className="text-xs text-blue-600 mt-1">
                  Base fee: $1.10 + ($0.0033 × {totalSelectedShares} shares)
                </div>
              </div>
            )}
            ...
            {sellPrice && (
              <div className="mb-3">
                <div className="text-sm text-blue-700 mb-1">Estimated Net Earnings:</div>
